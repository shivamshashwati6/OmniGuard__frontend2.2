    ...
    <div className="flex flex-col items-center justify-center min-h-full py-12 px-6">
      <div className="max-w-4xl w-full">
         <div className="text-center mb-12">
            ...
            <h1 className="text-6xl font-black mb-8 tracking-[-0.05em] uppercase" style={{ color: '#ff3131', textShadow: '0 0 10px #ff3131, 0 0 20px #ff3131' }}>
               EMERGENCY_SOS_LINK
            </h1>
            <p className="text-slate-500 font-black text-sm max-w-lg mx-auto leading-relaxed uppercase tracking-[0.2em]" style={{ textShadow: '0 0 5px rgba(255, 255, 255, 0.3)' }}>
          ...
          <div className="bg-[#12151a] border border-[#00ff96] rounded-[4rem] shadow-[0_0_30px_rgba(0,255,150,0.15)] p-10 md:p-16 relative overflow-hidden group">
