    ...
    <div className="flex flex-col items-center justify-center min-h-full py-12 px-6">
      <div className="max-w-4xl w-full">
         <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-black mb-6 tracking-[-0.05em] uppercase" style={{ color: '#ff4582', textShadow: '0 0 15px rgba(255, 69, 130, 0.9)' }}>
               EMERGENCY_SOS_LINK
            </h1>
            <p className="text-[#eaeaea] font-black text-sm max-w-lg mx-auto leading-relaxed uppercase tracking-[0.1em]">
         ...
         <div className="bg-[#16191f] border border-white/10 rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.8)] p-8 md:p-12 relative overflow-hidden group">
