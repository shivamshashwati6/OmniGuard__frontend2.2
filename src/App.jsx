  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="*" element={
          <div className="flex h-screen bg-obsidian text-slate-300 overflow-hidden font-sans">
                  ...
                  <Route path="/profile" element={
                    <ProtectedRoute user={user}>
                      <div className="flex flex-col items-center justify-center h-full text-slate-400">
                        ...
                        <p className="italic text-tactical-cyan font-mono uppercase text-xs mt-1">{user.role} ACCESS</p>
                      </div>
                    </ProtectedRoute>
                  } />
